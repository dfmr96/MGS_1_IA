...
namespace DefaultNamespace
{
    public class RatBoidController : MonoBehaviour
    {
        ...
        private void InitializeFSM()
        {
            ...
            var flockingState =
                new RatBoidSteeringState<StateEnum>(_ratModel, GetComponent<FlockingManager>(), _ratModel.Obs);
        ...
        private void InitDecisionTree()
        {
            ...
            var qLeaderInView = new QuestionTree(() => _ratModel.InView(_leaderDetectionLoS, ratLeader.transform),
                flock, chase);
